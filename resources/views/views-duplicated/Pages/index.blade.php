            ...
            <form action="{{ action('MainController@transaction') }}" method="post" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="shares" value="shares" name="bankShare" class="custom-control-input">
                        <label class="custom-control-label" for="shares">Shares transaction</label>
                    </div>
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="bank" name="bankShare" value="bank" checked class="custom-control-input">
